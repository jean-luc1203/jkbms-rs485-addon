...
## ⚡️ Enhancements	🚨Alarm management implementations 🚨
 * [ ] One BMS with the switches **set to 0000**
    It is therefore the master of the RS485 bus and, for my module, it is in broadcasting mode

![Alarm(s)](https://github.com/jean-luc1203/jkbms-rs485-addon/blob/main/images/Alarms-broadcasting.png)
...
- ❶ `binary_sensor.bms_global_bms_global_alarm`	It indicates if any of the BMS are in alarm mode.
  It can take the values `"off"` ou `"on"`   *device_class: problem* 
